...
export default function Teste4_1_1() {
    ...
    <Text style={styles.valor1}>{vetor[0]},{vetor[1]},{vetor[2]},{vetor[3]},{vetor[4]},
      ...
      <Animatable.View animation="zoomIn" style={styles.viewBtn}>
          <View style={styles.viewBtn1e2}>
            ...
            <TouchableOpacity style={styles.btn} onPress={() => opcao(possibilidadesRestantes[2],possibilidadesRestantes[4])}>
              <Text style={styles.btnNum}>{possibilidadesRestantes[2]} e {possibilidadesRestantes[4]}</Text>
            </TouchableOpacity>
          ...
          <View style={styles.viewBtn3e4}>
            ...
            <TouchableOpacity style={styles.btn} onPress={() => opcao(possibilidadesRestantes[3],possibilidadesRestantes[5])}>
              <Text style={styles.btnNum}>{possibilidadesRestantes[3]} e {possibilidadesRestantes[5]}</Text>
            </TouchableOpacity>
          </View>
      </Animatable.View>
